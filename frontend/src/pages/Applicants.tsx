...
export default function Applicants() {
  ...
  const handleExportApplicant = async (format: "pdf" | "docx") => {
    ...
    try {
      ...
      // ════════════════════════════════════════════════════════════════════
      //  PDF — CS Form No. 212 (Revised 2025) faithful layout
      // ════════════════════════════════════════════════════════════════════
      if (format === "pdf") {
        ...
        txt("Revised 2025", ML, y + metaH / 2, CW, metaH / 2, 6, false, DGRAY, "center");
        y += metaH;
      ...
      // ════════════════════════════════════════════════════════════════════
        ...
        const doc = new Document({ sections: [{ children: [
          new Paragraph({ alignment: AlignmentType.CENTER, spacing:{after:40}, children:[new TextRun({text:"CS Form No. 212 (Revised 2025)",size:18})] }),
          ...
          <div class="page">
            <table class="pds">
              ...
              <tr>
                ...
                <td colspan="10" style="background:#f2f2f2;text-align:center;font-size:7pt;padding:3px;height:${RH_BAR}px;max-height:${RH_BAR}px;overflow:hidden;white-space:nowrap;">Revised 2025</td>
              </tr>
              <!-- Title -->
